	...
	Tools = ordered() {
		...
		Path1Displacement = BezierSpline {
			...
			KeyFrames = {
				...
				[_END_FRAME_] = { 1, LH = { 117.666666666667, 1 }, Flags = { Linear = true, LockedY = true } }
			}
		},
		TransformZoomInPositionX = BezierSpline {
			...
			KeyFrames = {
				...
				[_END_FRAME_] = { -0.2, LH = { 76.6666666666667, -0.133333333333333 }, Flags = { Linear = true } }
			}
		},
		...
		TransformZoomInZoom = BezierSpline {
			...
			KeyFrames = {
				...
				[_END_FRAME_] = { 1.4, LH = { 76.6666666666667, 1.26666666666667 }, Flags = { Linear = true } }
			}
		}
	},
	ActiveTool = "Group1"
